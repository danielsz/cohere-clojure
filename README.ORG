...
An example of such specialized tasks is a coding assistant. The [[https://github.com/ruped/clojurellm-data][ClojureLLM]] team curates data sources for the fine-tuning of an LLM for Clojure. We are going to do just that on Cohere's platform.
